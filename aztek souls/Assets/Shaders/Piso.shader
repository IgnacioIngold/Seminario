...
Shader "Piso"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			o.Normal = BlendNormals( UnpackScaleNormal( tex2D( _TextureSample1, temp_output_65_0 ), _NormalIntensity ) , UnpackScaleNormal( tex2D( _TextureSample5, temp_output_65_0 ), _NormalIntensity ) );
...
/*ASEBEGIN
Version=16700
252;608;1092;393;1229.341;130.4414;1.6;True;False
...
ASEEND*/
//CHKSM=8B549E8C4FDACB107AB15B6023D147DE288A53A2